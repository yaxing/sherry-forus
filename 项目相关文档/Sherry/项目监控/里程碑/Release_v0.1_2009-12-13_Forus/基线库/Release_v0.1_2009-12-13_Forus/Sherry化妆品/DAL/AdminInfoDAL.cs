...
namespace DAL
{
    public class AdminInfoDAL:UserInfoDAL
    {
        ...
        {
            sqlString = "Insert Into adminInfo (adminID,adminRealName,emailAdd,phoneMun,adminLv)"
            ...
            pt[3].Value = newadmin.AdminLv;
            pt[4].Value = newadmin.AdminPhoneNum;
        ...
        {
            string sqlString = "Update adminInfo Set adminRealName = @adminRealName , emailAdd = @emailAdd , phoneMun = @phoneNum , adminLv = @adminLv "
