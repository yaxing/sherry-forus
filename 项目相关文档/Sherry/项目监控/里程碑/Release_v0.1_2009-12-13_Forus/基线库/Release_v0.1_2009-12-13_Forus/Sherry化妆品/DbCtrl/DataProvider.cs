...
{
    /// <summary>
    ///  包含测试内容，读取数据库连接字符串的web.config文件路径被硬编码。
    /// </summary>
    public class DataProvider : IDisposable
    {
        ...
        public string GetConnectionString()
        {
            ...
            string xmlFile = @"C:\Users\admin\Desktop\test\Release_v0.1_2009-12-13_Forus\基线库\Release_v0.1_2009-12-13_Forus\Sherry化妆品\DbCtrl\web.config";
