...
namespace DAL
{
    public class MailDAL
    {
        ...
        public bool SendEmail(string toMail , string mailTitle , string mailBody)
        {
            try
            {
                SmtpSection mailConfig = NetSectionGroup.GetSectionGroup(WebConfigurationManager.OpenWebConfiguration(@"C:\Users\admin\Desktop\test\基线库\Release_v0.1_2009-12-13_Forus\Sherry化妆品\DbCtrl\web.config")).MailSettings.Smtp;
