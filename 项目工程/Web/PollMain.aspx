...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="Server">
    <div align="center">
        ...
        <tr>
            <td colspan="2"><asp:LinkButton ID="lbPoll" CommandName="poll" CommandArgument='<%# ((DataRowView)Container.DataItem)["mainPollID"] %>' runat="server">ͶƱ</asp:LinkButton></td>
        </tr>
        <tr>
            <td align="left">
                <asp:LinkButton ID="prev" CommandName="prev" runat="server">prev</asp:LinkButton></td>
            <td align="right">
                <asp:LinkButton ID="next" CommandName="next" runat="server">next</asp:LinkButton></td>
        </tr>
        </table>
