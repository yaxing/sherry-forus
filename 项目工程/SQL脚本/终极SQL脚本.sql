...
--MainUpload表 处理上传文件主表
CREATE TABLE [dbo].[MainUpload](
	[mainUploadID] [int] IDENTITY(1,1) NOT NULL primary key,
...
--SubUpload表 处理上传文件 辅表
CREATE TABLE [dbo].[SubUpload](
	[subUploadID] [int] IDENTITY(1,1) NOT NULL primary key,
	[mainUploadID] [int] NULL references MainUpload(mainUploadID),
	[goodsID] [int] NULL,
