...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <div align="center">
                <asp:Panel ID="ConditionPan" runat="server" Width="281px" GroupingText="请选择调查重点">
                    <table>
                        <tr>
                ...
                <asp:Panel ID="AgeGroupPan" runat="server" Width="281px" GroupingText="请选择年龄段">
                    &nbsp;
                    ...
                    <asp:Panel ID="line1" runat="server" Height="25px" Width="230px">
                        ...
                        <asp:RangeValidator ID="RangeValidator5" runat="server" ControlToValidate="tbx12"
                            Display="Dynamic" ErrorMessage="年龄应是1到100之间则整数" MaximumValue="100" MinimumValue="1"
                            Type="Integer">*</asp:RangeValidator>
                        <asp:TextBox ID="tbx12" runat="server" Width="37px"></asp:TextBox>岁<asp:CompareValidator
                            ID="CompareValidator1" runat="server" ControlToCompare="tbx12" ControlToValidate="tbx11"
                            Display="Dynamic" ErrorMessage="起始年龄不应大于截止年龄" Operator="LessThanEqual">*</asp:CompareValidator>
                    </asp:Panel>
                    <asp:Panel ID="line2" runat="server" Height="25px" Width="230px">
                        ...
                        <asp:RangeValidator ID="RangeValidator6" runat="server" ControlToValidate="tbx22"
                            Display="Dynamic" ErrorMessage="年龄应是1到100之间则整数" MaximumValue="100" MinimumValue="1"
                            Type="Integer">*</asp:RangeValidator>
                        <asp:TextBox ID="tbx22" runat="server" Width="37px"></asp:TextBox>岁<asp:CompareValidator
                            ID="CompareValidator2" runat="server" ControlToCompare="tbx22" ControlToValidate="tbx21"
                            Display="Dynamic" ErrorMessage="起始年龄不应大于截止年龄" Operator="LessThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="CompareValidator5" runat="server" ControlToCompare="tbx12"
                            ControlToValidate="tbx21" Display="Dynamic" ErrorMessage="年龄段之间不应有重叠" Operator="GreaterThan">*</asp:CompareValidator></asp:Panel>
                    <asp:Panel ID="line3" runat="server" Height="25px" Width="230px">
                        ...
                        <asp:RangeValidator ID="RangeValidator7" runat="server" ControlToValidate="tbx32"
                            Display="Dynamic" ErrorMessage="年龄应是1到100之间则整数" MaximumValue="100" MinimumValue="1"
                            Type="Integer">*</asp:RangeValidator>
                        <asp:TextBox ID="tbx32" runat="server" Width="37px"></asp:TextBox>岁<asp:CompareValidator
                            ID="CompareValidator3" runat="server" ControlToCompare="tbx32" ControlToValidate="tbx31"
                            Display="Dynamic" ErrorMessage="起始年龄不应大于截止年龄" Operator="LessThanEqual">*</asp:CompareValidator>
                        <asp:CompareValidator ID="CompareValidator6" runat="server" ControlToCompare="tbx22"
                            ControlToValidate="tbx31" Display="Dynamic" ErrorMessage="年龄段之间不应有重叠" Operator="GreaterThan">*</asp:CompareValidator></asp:Panel>
                    <asp:Panel ID="line4" runat="server" Height="25px" Width="230px">
                        ...
                        <asp:RangeValidator ID="RangeValidator8" runat="server" ControlToValidate="tbx42"
                            Display="Dynamic" ErrorMessage="年龄应是1到100之间则整数" MaximumValue="100" MinimumValue="1"
                            Type="Integer">*</asp:RangeValidator>
                        <asp:TextBox ID="tbx42" runat="server" Width="37px"></asp:TextBox>岁<asp:CompareValidator
                            ID="CompareValidator4" runat="server" ControlToCompare="tbx42" ControlToValidate="tbx41"
                            Display="Dynamic" ErrorMessage="起始年龄不应大于截止年龄" Operator="LessThanEqual">*</asp:CompareValidator>
                ...
                <asp:Panel ID="TimeGapPan" runat="server" Width="281px" GroupingText="请选择时间段"
                            ...
                            <td>
                                <asp:Panel ID="Panel1" runat="server" Height="50px" Width="200px" GroupingText="起始日期">
                                    ...
                                    <asp:RangeValidator ID="sMonthRangeVali" runat="server" ControlToValidate="tbxStartingMonth"
                                        Display="Dynamic" ErrorMessage="RangeValidator" Type="Integer" MaximumValue="12"
