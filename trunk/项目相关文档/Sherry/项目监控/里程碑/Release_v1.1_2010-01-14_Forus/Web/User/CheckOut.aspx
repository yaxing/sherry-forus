...
<asp:Content ID="Content1" ContentPlaceHolderID="contentHolder" runat="Server">
    ...
    <asp:Panel runat="server" ID="pAnonymous">
        <div style="position: relative; left: 100px; top: 60px;">
            您还未登录，请先登录或者<a href="/Web/Register.aspx?checkOut=1">注册</a>
                                ...
                                <table border="0" cellpadding="1" cellspacing="0">
                                    ...
                                    <tr>
                                        <td colspan="3" align="left">
                                            <a href="/Web/GetPassword.aspx">忘记密码？</a>
                                        </td>
                                        <td>
                                        </td>
                                        <td>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left">
                                            <asp:ImageButton ID="LoginButton" runat="server" CommandName="Login" ImageUrl="/Web/images/login.jpg"
                ...
                <table>
                    <tr>
                        <td align="right" style="width: 230px; border-bottom-style: dotted; border-bottom-color: black;
                            ...
                            <asp:ImageButton ID="imgbCancelChange" runat="server" Width="85px" ImageUrl="/Web/images/cancel.jpg"
                        ...
                        <td align="right" style="border-bottom-style: dotted; border-bottom-color: black;
                            border-bottom-width: 1px">
                            <asp:ImageButton ID="imgbSaveAddChange" runat="server" Width="85px" ImageUrl="/Web/images/saveChange.jpg"
                ...
                <table>
                    ...
                    <tr>
                        <td style="width: 305px" align="right">
                            <asp:ImageButton ID="imgbCancelPayChange" Width="85px" runat="server" ImageUrl="/Web/images/cancel.jpg"
                                OnClick="imgbCancelChange_Click" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td>
                            <asp:ImageButton ID="imgbSavePay" Width="85px" runat="server" ImageUrl="/Web/images/saveChange.jpg"
            ...
            <div style="position: relative; left: 0px; top: 15px; width: 200px; border-style: solid;
                ...
                <table style="width: 200px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:ImageButton Width="85px" ImageUrl="/Web/images/changeItems.jpg" runat="server" ID="imgbChangeItems"
            ...
            <div style="position: relative; left: 50px; top: 30px; height: 320px">
                <table style="font-family: 微软雅黑">
                    ...
                    <tr>
                        ...
                        <td align="right" style="border-bottom-style: dotted; border-bottom-color: black;
                            border-bottom-width: 1px">
                            <asp:ImageButton ID="imgbAddNew" runat="server" Width="85px" ImageUrl="/Web/images/change.jpg"
                    ...
                    <tr>
                        ...
                        <td align="right" style="border-bottom-style: dotted; border-bottom-color: black;
                            border-bottom-width: 1px">
                            <asp:ImageButton ID="imgbPayNew" runat="server" Width="85px" ImageUrl="/Web/images/change.jpg"
                ...
                <table>
                    ...
                    <tr>
                        <td align="right">
                            <asp:ImageButton ID="imgbBack" Width="85px" runat="server" ImageUrl="/Web/images/cancel.jpg"
                                OnClick="imgbCancelShipping_Click" />
                        </td>
                        <td style="width: 5px">
                        </td>
                        <td style="height: 19px">
                            <asp:ImageButton ID="imgbConfirm" Width="85px" runat="server" ImageUrl="/Web/images/confirm.jpg"
